    ...
    if (!has_action('navbar_search')) {
        ...
        <form class="ms-1 md-flex" role="search" method="get" id="searchform"
            ...
            <div class="input-group">
                ...
                <button type="submit" id="searchsubmit" value="<?php esc_attr_x('Search', 'b5st') ?>"
...
function b5st_bottomline()
{
    if (!has_action('bottomline')) {
        ...
        <div class="container">
            <div class="row pt-3">
                <div class="col-sm">
                    <p class="text-center text-sm-start">&copy; <?php echo date('Y'); ?> <a
                                href="<?php echo home_url('/'); ?>"><?php bloginfo('name'); ?></a></p>
                </div>
                <div class="col-sm">
                    <p class="text-center text-sm-end"><a href="">Site Info</a></p>
                </div>
            </div>
        </div>
        <?php
