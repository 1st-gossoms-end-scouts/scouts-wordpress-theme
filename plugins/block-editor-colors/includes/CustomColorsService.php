...
class CustomColorsService {
	...
	public function set_color_cpt() {
		register_post_type( $this->color_cpt_slug, array(
			'label'  => esc_html__( 'Editor Color', 'scouts-wordpress-theme' ),
			'labels' => array(
				'name'          => esc_html__( 'Editor Colors', 'scouts-wordpress-theme' ),
				'singular_name' => esc_html__( 'Editor Color', 'scouts-wordpress-theme' ),
				'add_new'       => esc_html__( 'Add Editor Color', 'scouts-wordpress-theme' ),
				'add_new_item'  => esc_html__( 'Add Editor Color', 'scouts-wordpress-theme' ),
				'edit_item'     => esc_html__( 'Edit Editor Color', 'scouts-wordpress-theme' ),
				'new_item'      => esc_html__( 'New Editor Color', 'scouts-wordpress-theme' ),
				'view_item'     => esc_html__( 'View Editor Color', 'scouts-wordpress-theme' ),
				'search_items'  => esc_html__( 'Find Editor Color', 'scouts-wordpress-theme' ),
				'not_found'     => esc_html__( 'Editor Color Not Found', 'scouts-wordpress-theme' ),
				'menu_name'     => esc_html__( 'Editor Colors', 'scouts-wordpress-theme' ),
			),
			'public' => false,
		) );
	}
    ...
    public function add_color_prog($name, $slug, $color) {
	...
	public function edit_color() {
		...
		if ( ! isset( $_POST['color_id'] ) ) {
			wp_die( esc_html__( 'You must specify Color ID', 'scouts-wordpress-theme' ) );
		}
    ...
    public function delete_all_colors() {
